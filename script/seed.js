...
async function seed() {
  ...
  const homes = await Home.create([{
    ...
    description: 'Ghost hunters may want to add this house their list of potentially haunted homes. The listing description hints at the possibility of the 1870 Victorian being haunted, but it might also just be old. “come see for yourself.”',
    type: 'Haunted',
    price: faker.commerce.price(),
    ...
    description: 'This is a unique and amazing one-of-a-kind property in Southern Oregon! Located just a short distance from town, this property offers 120 acres surrounded by mountains! The home offers well-crafted construction and a fully off-grid, solar system.',
    type: 'Eco-friendly',
    price: faker.commerce.price(),
    ...
    description: 'State of the art off the grid living with million dollar views on 20 acres just 25 minutes from downtown Taos,NM! 16 inch Pumicecrete walls w/ solar electricity, solar hot water, catchment, community well for TRUE off grid living-NO BILLS, just FRILL',
    type: 'Eco-friendly',
    price: faker.commerce.price(),
    ...
    description: 'Steel frame wood studs closed cell foam insulation throughout custom ceiling retractable awning and front deck tankless propane water heater gas stove full-size appliances full-size bathroom two sleeping loss storage throughout.',
    type: 'Eco-friendly',
    price: faker.commerce.price(),
